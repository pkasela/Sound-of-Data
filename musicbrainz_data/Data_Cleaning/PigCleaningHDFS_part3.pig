...
artist_tag_colder = JOIN  artist_cooler BY artist_id RIGHT,
                          artist_tag_cold BY artist_id;
artist_tag_cooler = FOREACH artist_tag_colder GENERATE gid AS START_ID,
    tag_id AS END_ID, 'GENRE' AS TYPE;
...
recording_tag_colder = JOIN  recording_cooler BY recording_id RIGHT,
                          recording_tag_cold BY recording_id;
recording_tag_cooler = FOREACH recording_tag_colder GENERATE gid AS START_ID,
    tag_id AS END_ID, 'GENRE' AS TYPE;
...
release_tag_colder = JOIN  release_cooler BY release_id RIGHT,
                          release_tag_cold BY release_id;
release_tag_cooler = FOREACH release_tag_colder GENERATE gid AS START_ID,
    tag_id AS END_ID, 'GENRE' AS TYPE;
