...
neo4j-import --into SoundofData.db --nodes artist.tsv --nodes release.tsv --nodes release_group.tsv --nodes recording.tsv --nodes label.tsv --relationships artist_label.tsv --relationships artist_recording.tsv --relationships artist_release.tsv --relationships artist_release_group.tsv --relationships label_recording.tsv --relationships label_release.tsv --relationships label_release_group.tsv --relationships recording_release.tsv --relationships release_release_group.tsv  --delimiter="\t" --quote="\""
