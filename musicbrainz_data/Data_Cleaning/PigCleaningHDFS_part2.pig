...
recording_release = LOAD
  '/mbdump/l_recording_release.tsv'
USING PigStorage('\t') AS
  (
...
STORE recording_cooler INTO
 '/demo_results/pig_recording'
USING PigStorage('\t','-schema');

STORE artist_recording_cooler INTO
 '/demo_results/pig_artist_recording'
USING PigStorage('\t','-schema');

------ relationship FILES  ----------

STORE label_recording_cooler INTO
 '/demo_results/pig_label_recording'
USING PigStorage('\t','-schema');

STORE recording_release_cooler INTO
 '/demo_results/pig_recording_release'
USING PigStorage('\t','-schema');
